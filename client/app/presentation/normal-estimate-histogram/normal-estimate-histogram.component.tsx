...
export interface NormalEstimateHistogramProps { title: string, taskID: string };
    ...
    return (
      <div className="slide basic-slide">
        ...
        <div style={{ height: "400px", width: "100%", maxWidth: "600px" }}>
          {this.state.estimateDistribution && <DistributionHistogram distribution={this.state.estimateDistribution} />}
        </div>
      </div >
    );
  }
